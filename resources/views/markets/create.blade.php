...
@section('container')
    <main class="container">
        <h1 class="alert alert-success text-center"><i class="fa fa-home" aria-hidden="true"></i> &nbsp;Create a new Market</h1>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="value" id="value"
                               aria-describedby="value" value="{{old('value') }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="employees_quantity" id="employees_quantity"
                               aria-describedby="employees_quantity" value="{{old('employees_quantity') }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="occupancy_rate" id="occupancy_rate"
                               aria-describedby="occupancy_rate" value="{{old('occupancy_rate') }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        @if(old('occupancy_rate')==1)
